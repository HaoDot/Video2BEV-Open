...
from tool.Dataloader_University import Sampler_University,Dataloader_University,train_collate_fn
...
def make_dataset(opt):
    ...
    # custom Dataset
    # satellite_anchor_based_sampling
    image_datasets = Dataloader_University(opt.data_dir,transforms=data_transforms,sd_negative_sample=opt.sd_negative_sample)
    ...
    drone_based_image_datasets = Dataloader_University(opt.data_dir, transforms=data_transforms,sd_negative_sample=opt.sd_negative_sample)
    samper = Sampler_University(drone_based_image_datasets, batchsize=opt.batchsize, sample_num=opt.sample_num)
    drone_based_dataloaders = torch.utils.data.DataLoader(drone_based_image_datasets, batch_size=opt.batchsize, sampler=samper,
                                              num_workers=opt.num_worker, pin_memory=True, collate_fn=train_collate_fn)
    return dataloaders,class_names,dataset_sizes, drone_based_dataloaders
