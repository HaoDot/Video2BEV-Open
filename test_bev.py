...
from evaluate_gpu_api import evaluate_root
...
model_dir_name = 'model_2024-03-06-17:44:39'
...
if __name__ == "__main__":
    ...
    evaluate_root(query_name,gallery_name,os.path.join(absolute_path,'{}'.format(model_dir_name),'{}'.format(opt.name)))
