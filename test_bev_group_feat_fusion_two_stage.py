...
parser.add_argument('--model_dir_name',default='model_2024-08-31-07:20:44', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
parser.add_argument('--model_dir_name_epoch',default='model_2024-08-31-07:20:44_059', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')

# parser.add_argument('--query_name',default='query_satellite', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
parser.add_argument('--query_name',default='satellite', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
...
parser.add_argument('--gallery_name',default='bev', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
...
def extract_feature(model,dataloaders,opt, view_index = 1):
    ...
    for data in dataloaders:
        ...
        if opt.lpn:
            ...
            if opt.itc:
                ff = torch.FloatTensor(n, 768 * opt.block).zero_().cuda()
            else:
                ff = torch.FloatTensor(n, 1024, opt.block).zero_().cuda()
        ff_full_seq = torch.FloatTensor(n, 768).zero_().cuda()
