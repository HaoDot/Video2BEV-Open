...
parser.add_argument('--model_dir_name',default='model_2025-01-26-05:51:43', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
parser.add_argument('--model_dir_name_epoch',default='model_2025-01-26-05:51:43_059', type=str,help='multiple_scale: e.g. 1 1,1.1  1,1.1,1.2')
